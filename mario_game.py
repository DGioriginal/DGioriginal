...
cactus_img = pygame.image.load('D:\IMAGES\=).bmp')
cactus_img_rect = cactus_img.get_rect()
cactus_img_rect.left = 0
fire_img = pygame.image.load('D:\IMAGES\platform.png')
...
class Dragon:
    ...
    def __init__(self):
        self.dragon_img = pygame.image.load('D:\IMAGES\huio.png')
...
class Flames:
    ...
    def __init__(self):
        self.flames = pygame.image.load('D:\IMAGES\meteor_1.png')
        self.flames_img = pygame.transform.scale(self.flames, (30, 20))
...
class Mario:
    ...
    def __init__(self):
        self.mario_img = pygame.image.load('D:\IMAGES\mario.jpg')
...
def game_over():
    ...
    music = pygame.mixer.Sound('D:\MUSIKA\GOkiPPA.mp3')
    music.play()
    topscore.top_score(SCORE)
    game_over_img = pygame.image.load('D:\IMAGES\Exit.png')
...
def start_game():
    canvas.fill(BLACK)
    start_img = pygame.image.load('D:\IMAGES\GOkiPPA.png')
...
def game_loop():
    while True:
        ...
        global  HIGH_SCORE
        flames_list = []
        pygame.mixer.music.load('D:\MUSIKA\dzidzo_feat_ivan_popovich_-_vasilina_(zvukoff.ru).mp3')
